...
Preferred path: explicitly spawn 3 native Codex subagents, then wait for all
three before synthesis. Each subagent receives:
...
- **Reference file resolution**: `references/*.md` are relative to the skill
  ...
  (global) or the repo's `codex-skills/df-prd-challenge/references/`
