...
Build each critic's prompt from this template. Fill in the placeholders. The same brief goes to both family legs: the Codex critic (in-session or spawned) and the Claude critic sent through the cross-model transport.
