...
Start by finding the relevant code. Glob for directories and files, grep for key symbols, then read the actual implementation. Don't guess from names. Read the code.
