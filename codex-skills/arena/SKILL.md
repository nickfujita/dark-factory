...
Spawn all N candidates as background native Codex subagents, in one wave. Each gets the task, a pointer to the shared grounding, its own output path, and instructions to produce both the artifact and a short rationale.
