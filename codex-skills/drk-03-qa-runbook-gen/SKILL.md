...
(This file is in the skill directory: `${CODEX_SKILLS_HOME:-${CODEX_HOME:-$HOME/.codex}/skills}/drk-03-qa-runbook-gen/references/`
or the repo's `codex-skills/drk-03-qa-runbook-gen/references/` directory. If neither
...
(This file is in the skill directory: `${CODEX_SKILLS_HOME:-${CODEX_HOME:-$HOME/.codex}/skills}/drk-03-qa-runbook-gen/references/`
or the repo's `codex-skills/drk-03-qa-runbook-gen/references/` directory.)
...
### Step 7: Return Validation-Ready Artifacts

After the QA runbook is generated, report both paths:
- PRD path: the source PRD used for generation
- QA runbook path: the just-generated `docs/qa/qa-<feature-slug>.md`

When running under `dark-factory-codex`, stop here so the orchestrator can
explicitly invoke `drk-04-qa-runbook-validation` with both paths. If this skill
was invoked standalone, tell the user the next stage is
...
- **Reference file resolution**: `references/runbook-template.md` and
  ...
  Look in `${CODEX_SKILLS_HOME:-${CODEX_HOME:-$HOME/.codex}/skills}/drk-03-qa-runbook-gen/references/` (global) or
  the repo's `codex-skills/drk-03-qa-runbook-gen/references/` directory.
