...
*Things you noticed during the sketch that the operator needs to weigh in on, and risks worth flagging before implementation starts. Phrase as questions, not assertions, so the operator's answer is the resolution rather than a comment.*

## Next implementation step

*The first thing to build against the sketch. One sentence. What you'd start writing immediately after synthesis (or after the Phase C sign-off, in the lanes that pause there).*
