...
Trigger `df-qa-validation` with the PRD path and the entry list from step 6.
Start it immediately after step 6. Only skip when the operator explicitly asks
to defer it.
