...
Build each critic's prompt from this template. Fill in the placeholders. The same brief goes to both family legs: the Claude critic (in-session or spawned) and the Codex critic sent through the cross-model transport.
