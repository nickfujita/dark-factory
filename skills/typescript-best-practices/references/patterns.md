...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see **type-system-discipline** and **boundary-discipline** in the df skill's `references/principles.md`.
