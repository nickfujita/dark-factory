...
Large-trail reader calls use `menial_scoped_investigation`; this parent owns
terminal completion for each leaf. Follow the inventory's native contract
