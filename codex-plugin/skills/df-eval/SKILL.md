...
The operator invoking `$df-eval` is the only entry. When a skill change lands without an eval run, you may suggest `$df-eval` in one line and continue the turn normally. Never enter on your own.
