...
for s in df-state.sh df-check-leakage.sh df-stack.sh df-selection.mjs test-df-selection.sh; do
...
for ref in run-state-schema.md engineering-standards.md verification-selection.schema.json; do
